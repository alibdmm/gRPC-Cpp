...
#ifndef GOOGLE_PROTOBUF_INCLUDED_unaryMessage_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_unaryMessage_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_unaryMessage_2eproto
...
struct TableStruct_unaryMessage_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_unaryMessage_2eproto;
namespace message {
class MessageReply;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::message::MessageReply* Arena::CreateMaybeMessage<::message::MessageReply>(Arena*);
template<> ::message::MessageRequest* Arena::CreateMaybeMessage<::message::MessageRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace message {
...
class MessageRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:message.MessageRequest) */ {
 public:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_unaryMessage_2eproto;
};
// -------------------------------------------------------------------

class MessageReply final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:message.MessageReply) */ {
 public:
...
// string name = 1;
inline void MessageRequest::clear_name() {
  _impl_.name_.ClearToEmpty();
}
inline const std::string& MessageRequest::name() const {
  // @@protoc_insertion_point(field_get:message.MessageRequest.name)
  return _internal_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MessageRequest::set_name(ArgT0&& arg0, ArgT... args) {
 
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:message.MessageRequest.name)
}
inline std::string* MessageRequest::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:message.MessageRequest.name)
  return _s;
}
inline const std::string& MessageRequest::_internal_name() const {
  return _impl_.name_.Get();
}
inline void MessageRequest::_internal_set_name(const std::string& value) {
  
  _impl_.name_.Set(value, GetArenaForAllocation());
}
inline std::string* MessageRequest::_internal_mutable_name() {
  
  return _impl_.name_.Mutable(GetArenaForAllocation());
}
inline std::string* MessageRequest::release_name() {
  // @@protoc_insertion_point(field_release:message.MessageRequest.name)
  return _impl_.name_.Release();
}
inline void MessageRequest::set_allocated_name(std::string* name) {
  if (name != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:message.MessageRequest.name)
}
...
inline const std::string& MessageRequest::message() const {
  // @@protoc_insertion_point(field_get:message.MessageRequest.message)
...
void MessageRequest::set_message(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:message.MessageRequest.message)
}
inline std::string* MessageRequest::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:message.MessageRequest.message)
  return _s;
}
...
inline std::string* MessageRequest::release_message() {
  // @@protoc_insertion_point(field_release:message.MessageRequest.message)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:message.MessageRequest.message)
}
...
inline const std::string& MessageReply::message() const {
  // @@protoc_insertion_point(field_get:message.MessageReply.message)
  return _internal_message();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MessageReply::set_message(ArgT0&& arg0, ArgT... args) {
 
 _impl_.message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:message.MessageReply.message)
}
inline std::string* MessageReply::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:message.MessageReply.message)
  return _s;
}
...
inline std::string* MessageReply::release_message() {
  // @@protoc_insertion_point(field_release:message.MessageReply.message)
  return _impl_.message_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:message.MessageReply.message)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_unaryMessage_2eproto
